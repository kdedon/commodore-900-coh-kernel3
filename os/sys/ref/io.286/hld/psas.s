...
/ PS Hard Disk Assembler Support
	...
	.globl	com_data_, fcn_trn0_, fcn_trn1_,fcn_trn2_,fcn_trn7_,fcn_trn15_
	.globl  i0_, i1_, i2_, i7_, i15_, end_table_
...
sp_:	.blkw	0x24			
it_:	.blkw	432			/This gives room for 18 items
...
init_dev:
	...
	mov	 0,$72		/ Pointer to pointer 0. Note that as we add 
	...
	mov	32,$dev_blk7_	/   | devs 0, 1, 7, 15, 2
	mov	34,dx		/   |
	mov	36,$fcn_trn7_	/   |
	mov	38,dx		/   |
	mov	40,$dev_blk15_	/   |
	...
	mov	bx, cs:i7_	/ Initialize the system timer
	mov	cx,$1
	mov	dx,$4		/ Logical device 4
...
0:	mov	ax,$0xffff	/ Inform caller that we could not init
1:	ret
