...
/*
 * H-19 cursor-key sequences, indexed by CUP..CDOWN: up, left, right, down
 * send ESC A, ESC D, ESC C, ESC B -- the codes termcap names in ku/kl/kr/kd.
 * The raw CUP..CDOWN codes cannot reach a reader: the line discipline masks
 * input to seven bits in every mode but RAWIN, which turns cursor-down into
