/* Taken from the 3.2.1b include tree (include/sys/fdioctl.h) -- the 0.7.3
 * disk extraction has no fdioctl.h although drv/wd.c includes it and the
 * shipped wd.o proves it existed.  FDFORMAT (0100) is stable across Coherent
 * revs; struct fform layout unverified against the lost 0.7.3 original (TBD
 * if floppy formatting ever misbehaves).
 */
/* (-lgl
